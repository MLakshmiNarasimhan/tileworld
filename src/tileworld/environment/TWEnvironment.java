...
import tileworld.agent.LakshmiAgent;
import tileworld.agent.TharunAgent;
import tileworld.agent.HugoAgent;
import tileworld.agent.HemantAgent;
import tileworld.agent.JoleneAgent;
import tileworld.agent.HarshAgent;
...
//    }
    ...
    public void start() {
        ...
        //Now we create 6 named agents, each with a unique role and zone
        Int2D p1 = this.generateRandomLocation();
        createAgent(new LakshmiAgent("LakshmiAgent", p1.getX(), p1.getY(), this, Parameters.defaultFuelLevel));
        Int2D p2 = this.generateRandomLocation();
        createAgent(new TharunAgent("TharunAgent", p2.getX(), p2.getY(), this, Parameters.defaultFuelLevel));
        Int2D p3 = this.generateRandomLocation();
        createAgent(new HugoAgent("HugoAgent", p3.getX(), p3.getY(), this, Parameters.defaultFuelLevel));
        Int2D p4 = this.generateRandomLocation();
        createAgent(new HemantAgent("HemantAgent", p4.getX(), p4.getY(), this, Parameters.defaultFuelLevel));
        Int2D p5 = this.generateRandomLocation();
        createAgent(new JoleneAgent("JoleneAgent", p5.getX(), p5.getY(), this, Parameters.defaultFuelLevel));
        Int2D p6 = this.generateRandomLocation();
        createAgent(new HarshAgent("HarshAgent", p6.getX(), p6.getY(), this, Parameters.defaultFuelLevel));
